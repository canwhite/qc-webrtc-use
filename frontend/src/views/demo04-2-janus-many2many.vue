...
<script>
	/**
	 * 实际上就是房东将房子挂在中介，然后想要房子的人去中介那里去购买一样。
	 * janus就是一个房产中介
	 * A、B、C 在和 SFU 网关进行 RTC 关联之后，
	 * A 订阅 B、C 的媒体流并不需要再去和 B、C 去“打交道”，
	 * 而是直接和网关交互，这就是 SFU 架构下媒体交互的基础流程
	 */
	...
	export default {
		...
		methods:{
			        ...
			        publisherPlugin.createAnswer(
			          {
			            ...
			            success: function(jsep) {
			              ...
			              var body = { request: "start", room:Number(that.roomNumber)};
			...
			createRoom(){
				...
				this.createJanusRoom(Number(this.roomNumber),20,500,null,"测试房间")
			},
